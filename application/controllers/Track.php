...
class Track extends CI_Controller {
	public function add()
	{
        ...
        $this->form_validation->set_rules('para', 'Paragraph', 'trim|required|min_length[5]|max_length[1000]');
        $this->form_validation->set_rules('aboutPara', 'About Paragraph', 'trim|min_length[5]|max_length[200]');
