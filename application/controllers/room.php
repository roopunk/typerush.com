...
class Room extends CI_Controller {
    ...
    public function start() {
        ...
        $this->form_validation->set_rules('track', 'Track', 'trim|required|integer|xss_clean');
	...
	public function enter($room_id)
	{
        ...
        if($this->room_model->checkRoomPresence($room_id)) {
            ...
            $this->form_validation->set_rules('username', 'Username', 'trim|required|min_length[3]|max_length[20]|xss_clean');
            $this->form_validation->set_rules('room_id', 'Room ID', 'trim|required|integer|xss_clean');
